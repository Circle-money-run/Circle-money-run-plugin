...
export class RandomMP3 extends plugin {
    constructor() {
        ...
        // 读取配置文件
        const configPath = path.join(__dirname, 'plugins/Circle-money-run-plugin/config/RandomMP3.yaml'); // 配置文件路径
        ...
        // 设置MP3文件夹路径
        this.mp3DirPath = path.join(__dirname, 'plugins/Circle-money-run-plugin/resources/MP3');//放MP3的文件夹
    }
